"""Alembic environment. Schema is owned by migrations, not create_all()."""
...
from careerpilot.infrastructure.persistence.postgres import models as _models  # noqa: F401
...
def _database_url() -> str:
    return to_sync_postgres_url(get_settings().database.url)
